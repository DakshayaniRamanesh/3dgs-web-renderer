...
const LOCATIONS = [
  {
    ...
    fileSize: '103.5 MB',
    file: 'https://huggingface.co/datasets/dakshi01/UOP_CAMPUS_TOUR/resolve/main/lion.ply',
    cameraUp: [0, -1, 0],
    cameraPos: [0, 0, 4.5],
    cameraLookAt: [0, 0, 0],
  },
  {
    ...
    file: 'https://huggingface.co/datasets/dakshi01/UOP_CAMPUS_TOUR/resolve/main/gyro.ply',
    cameraUp: [0, -1, 0],
    cameraPos: [0, 0, 4.5],
    cameraLookAt: [0, 0, 0],
  },
