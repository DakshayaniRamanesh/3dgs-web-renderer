...
const LOCATIONS = [
  {
    ...
    file: import.meta.env.VITE_SPLAT_LION_URL || 'https://huggingface.co/datasets/dakshi01/UOP_CAMPUS_TOUR/resolve/main/lion.ply',
    cameraUp: [0, -1, 0],
    cameraPos: [0, 0, 4.5],
    cameraLookAt: [0, 0, 0],
  },
  {
    ...
    file: import.meta.env.VITE_SPLAT_GYRO_URL || 'https://huggingface.co/datasets/dakshi01/UOP_CAMPUS_TOUR/resolve/main/gyro.ply',
    cameraUp: [0, -1, 0],
    cameraPos: [0, 0, 4.5],
    cameraLookAt: [0, 0, 0],
  },
